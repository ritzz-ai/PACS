...
from .pacs_compute_metrics import (
    compute_data_metrics,
)


class PACSTrainer(RayPPOTrainer):
    def __init__(self, config, **kwargs):
        ...
        assert (
            ...
            == 0
        ), "ppo_micro_batch_size_per_gpu must be divisible by rollout.n for pacs"
        print(f"PACSTrainer init with config: {config}")

    def fit(self):
        """
        The training loop of PACS.
        """
