...
from .pacs_trainer import PACSTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in ["fsdp", "fsdp2"]:
            ...
            from .pacs_workers import PACSActorRolloutRefWorker, PACSCriticWorker

            actor_rollout_cls = PACSActorRolloutRefWorker
        ...
        role_worker_mapping = {
            ...
            Role.Critic: ray.remote(PACSCriticWorker),
        }
        ...
        if (
            ...
            role_worker_mapping[Role.RefPolicy] = ray.remote(PACSActorRolloutRefWorker)
